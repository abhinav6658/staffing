...
function add_default_theme_menu_items() {
    ...
    if (!is_client_logged_in()) {
        ...
        if (has_contact_permission('Menu-1')) {
            add_theme_menu_item('Menu-1', [
                    'name'     => _l('Menu-1'),
                    'href'     => site_url('clients/invoices'),
                    'position' => 2,
                ]);
        ...
        if (has_contact_permission('Menu-2')) {
            add_theme_menu_item('Menu-2', [
                    'name'     => _l('Menu-2'),
                    'href'     => site_url('clients/estimates'),
                    'position' => 3,
                ]);
        }
		if (has_contact_permission('Menu-3')) {
            add_theme_menu_item('Menu-3', [
                    'name'     => _l('Menu-3'),
                    'href'     => site_url('clients/contracts'),
                    'position' => 4,
                ]);
...
function app_customers_footer() {
     ...
     */
    hooks()->do_action('customers_after_js_scripts_load');
}
/**
 * Customers area head
...
function active_clients_theme() {
    ...
    if ($theme == '') {
        show_error('Default clients area theme not configured in settings.');
    }
