...
*/
class Timesheetw2 extends CI_Controller
{
	...
	public function index() {
		...
		$this->templated->load('Backend/w2/default_layout', 'contents', 'timesheet/timesheet_w2', $data);
	}
		...
		if($this->input->get('id')){
           ...
           delete_files($path, true , false, 1);
			...
			$this->global_model->del_data('panel_timesheettbl',array("t_id"=>$this->input->get('id')));
									...
									redirect(base_url('timesheet-report-w2'),'location');
								} else {
	...
	public function timesheet_report_w2($report = null) {
		...
		$this->templated->load('Backend/w2/default_layout', 'contents', 'timesheet/timesheet_report_w2', $data);
	}

		public function timesheet_upload_w2() {
		...
		public function getPendingTimesheet_w2() {
		...
		$this->templated->load('Backend/w2/default_layout', 'contents', 'timesheet/consultlist_pen_timesheet', $data);
	}
	public function pending_timesheet_w2() {
		...
		//echo $start_date;
		//echo $end_date;
		$this->templated->load('Backend/w2/default_layout', 'contents', 'timesheet/upload_pending_timesheet_w2', $data);
	}
	else
	{
