...
function db_prefix()
{
return defined('APP_DB_PREFIX') ? APP_DB_PREFIX : 'panel_';
}

// Should be loaded here?
require_once(APPPATH . 'helpers/hooks_helper.php');
include_once(APPPATH . 'helpers/files_helper.php');
...
/*
|-------------------------------------------------------------------------
| Claim.MD UserID And AccountKey 
|-------------------------------------------------------------------------
|
*/
// $config['UserID'] = 'DEXTROUSINFO';
// $config['AccountKey'] = '7936EIVxSwdRsDzvdQHJsKHWjnUM';

// $config['UserID'] = 'korevv';
// $config['AccountKey'] = '8094XwMqMMdzZEMgdPruxEeUvBRG';

// $config['UserID'] = 'ahr';
// $config['AccountKey'] = '8095IOyhgeltRfShGdFvQXJRvvwC';
