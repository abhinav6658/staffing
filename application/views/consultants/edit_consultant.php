...
<div class="dashboard-countBox">
	...
	<div class="formBox">
		...
		<?php echo form_open('', array('id'=>'msform')); ?>
		...
		<!-- fieldsets -->
			<fieldset class="formSteps" id="form_fields">
				<div class="infiform-inline">
					...
					<input type="hidden" name="consultant_id" id="consultant_id" value="<?php echo $con_data[0]['guid']; ?>">
					<div class="form-group">
						<label>Client Name</label>
						<input type="text" name="name" id="client_name" class="form-control" value="<?php echo $mapping_data['client']?>" placeholder="Enter name">
					...
					<div class="form-group">
						<label>Name</label>
						<input type="text" name="name" id="consul_name" class="form-control" value="<?php echo $con_data[0]['name']?>" placeholder="Enter name">
					...
					<div class="form-group">
						<label>Email</label>
						<input type="email" name="email" id="consul_email" class="form-control" placeholder="Enter email" value="<?php echo $con_data[0]['email']; ?>">
					...
					<div class="form-group">
						<label>Phone</label>
						<input type="text" name="phone" id="consul_phone" class="form-control" placeholder="Enter phone" maxlength="12" value="<?php echo $con_data[0]['phone'];?>">
				...
				<div class="infiform-inline">
					<div class="form-group">
						...
						<select class="form-control" id="consultant_type">
							...
							<?php foreach($consul_type as $c_type) :?>
								<option value="<?php echo $c_type['consultant_type_id']; ?>" <?php if($mapping_data['consultant_type'] == $c_type['consultant_type_id']) { echo 'selected'; }?>><?php echo $c_type['consultant_type_name']; ?></option>
							<?php endforeach;?>
						</select>
					...
					<div class="form-group">
						...
						<select class="form-control" id="vendor_id">
							<?php if($mapping_data['consultant_type'] == 2) { ?>
								...
								?>
										<option value="<?php echo $vendors_value['guid']?>" <?php if($mapping_data['vendor_id'] == $vendors_value['guid']) { echo 'selected'; }?>><?php echo $vendors_value['name']?></option>
							<?php
									}
				...
				<div class="infiform-inline">
					<div class="form-group">
						...
						<input type="text" id="project_name" name="project_name" class="form-control" placeholder="Type project name" value="<?php echo $mapping_data['project_name']; ?>">
						<div class="alert alert-danger" id="pro_name_error" style="display: none;">
							<span>Please fill project name</span>
						</div>
					</div>
					<div class="form-group">
						<label>Timsesheet Frequency</label>
						<select name="con_frec" id="con_frec" class="form-control">
							<option value="">Select Frequency</option>
							<?php
								foreach ($conslt_frec as $conslt_frec_val) {
							?>
								<option value="<?php echo $conslt_frec_val['id'];?>" <?php if($mapping_data['consult_frequency'] == $conslt_frec_val['id']) { echo 'selected'; } ?>><?php echo $conslt_frec_val['frequency'];?></option>
							<?php
								}
							?>
						</select>
					...
					<div class="form-group">
						...
						<input type="text" name="start_date" id="datepicker" class="form-control dateicon datepicker" placeholder="MM DD YYYY" value="<?php echo date('m/d/Y', strtotime($mapping_data['start_date'])); ?>">
					...
					<div class="form-group">
						...
						<input type="text" name="end_Date" id="datepicker1" class="form-control dateicon datepicker" placeholder="MM DD YYYY" value="<?php if($mapping_data['end_date'] != "0000-00-00") { echo date('m/d/Y', strtotime($mapping_data['end_date'])); } ?>">
					...
					<div class="form-group">
						<label>Role</label>
						<input type="text" id="consultant_role" name="consultant_role" class="form-control" placeholder="Enter your role" value="<?php echo $mapping_data['role']; ?>">
					...
					<div class="form-group">
						...
						<input type="text" id="pro_location" name="pro_location" class="form-control" placeholder="Enter project location" value="<?php echo $mapping_data['project_location']; ?>">
						<div class="alert alert-danger" id="pro_loc_error" style="display: none;">
							<span>Please fill project location</span>
						</div>
					</div>
					<div class="form-group">
						<label>City</label>
						<input type="text" id="pro_city" name="pro_city" class="form-control" placeholder="Enter city" value="<?php echo $mapping_data['city']; ?>">
					...
					<div class="form-group">
						...
						<select name="pro_state" id="pro_state" class="form-control">
							...
							?>
									<option value="<?php echo $states_val['stateCode']; ?>" <?php if ($mapping_data['state']==$states_val['stateCode']) { echo 'selected'; }?>><?php echo $states_val['stateName']; ?></option>
							<?php
								}
							?>
						</select>
					...
					<div class="form-group">
						...
						<input type="text" id="recruiter_name" name="recruiter_name" class="form-control" placeholder="Enter recruiter name" value="<?php echo $mapping_data['recruiter_name']; ?>">
					...
					<div class="form-group">
						...
						<input type="text" id="manager_name" name="manager_name" class="form-control" placeholder="Enter manager name" value="<?php echo $mapping_data['manager_name']; ?>">
					...
					<div class="form-group">
						...
						<input type="text" id="remote_work" name="remote_work" class="form-control" placeholder="Enter manager name">
					</div>
				</div>
				<!-- <input type="button" name="previous" class="previous action-button-previous submit-btn" value="Previous"/>
	            ...
	            <div class="infiform-inline">
					...
					<div class="form-group">
						...
						<div class="three-control">
							...
							<input type="text" id="cost_price" name="cost_price" class="form-control vendor-control" value="<?php echo $mapping_data['cost'];?>">
							<select class="form-control vendor-sel" id="bill_rate_basis">
								<?php
									foreach ($rate_type as $rate_type_val) {
								?>
										<option value="<?php echo $rate_type_val['id']; ?>" <?php if($mapping_data['cost_rate_type'] == $rate_type_val['id']) { echo 'selected'; } ?>><?php echo $rate_type_val['cost_type_name']; ?></option>
								<?php
									}
								?>
							</select>
					...
					<div class="form-group">
						<label>Bill Rate Effective Date</label>
						<input type="text" name="bill_effective_date" id="datepicker3" class="form-control dateicon datepicker" value="<?php echo date("m/d/Y", strtotime($mapping_data['cost_effective_date'])); ?>">
					...
					<div class="form-group">
						...
						<div class="three-control">
							<span class="doller">$</span>
							<input type="text" id="sell_price" name="sell_price" class="form-control vendor-control" value="<?php echo $mapping_data['sell'];?>">
							<select class="form-control vendor-sel" id="pay_rate_basis">
								<?php
									foreach ($rate_type as $rate_type_val) {
								?>
										<option value="<?php echo $rate_type_val['id']; ?>" <?php if($mapping_data['sell_rate_type'] == $rate_type_val['id']) { echo 'selected'; } ?>><?php echo $rate_type_val['cost_type_name']; ?></option>
								<?php
									}
								?>
							</select>
					...
					<div class="form-group">
						<label>Pay Rate Effective Date</label>
						<input type="text" name="effective_date" id="datepicker2" class="form-control dateicon datepicker" value="<?php echo date('m/d/Y', strtotime($mapping_data['sell_effective_date'])); ?>">
...
<script type="text/javascript">
	...
	// 	var date_new = jQuery("#datepicker").val();
	// 	jQuery("#datepicker").prop("value", "");
	// 	document.getElementById("datepicker").value = date_new;
	// });
	...
	jQuery(".submit").click(function(e) {
		...
		var consult        = jQuery("#consultant_id").val();
		...
		if(c_type != "" && vend != "" && pro_name != "" && con_frqc != "" && srt_date != "" && emp_role != "" && pro_city != "" && pro_stat != "" && rec_name != "" && man_name != "" && cost_prc != "" && sell_prc != "" && eff_date != "" && bill_eff != "") {

			jQuery.ajax({
				url: "<?php echo base_url('Mappingajax/edit_mapping_data'); ?>",
				type: "GET",
				data: {
					client: client,
				...
				success: function(response) {
					...
					if(response == 1) {
						...
						alert("User exist for same email address.");
					}
				}
			});
		} else {
	...
	// 	if(c_type != "" && vend != "" && pro_name != "" && con_frqc != "" && srt_date != "" && end_date != "" && emp_role != "" && pro_locn != "" && pro_city != "" && pro_stat != "" && rec_name != "" && man_name != "" && cost_prc != "" && sell_prc != "" && eff_date != "" && bill_eff != "") {
	...
	// 		jQuery("#r_pay_rate").html(cost_prc);
	// 		jQuery("#r_bill_rate").html(sell_prc);
	// 		jQuery("#r_effective_date").html(eff_date);
	// 	} else {
	// 		if(consult_name  == "") {
	// 			jQuery("#consul_name_error").show();
	// 		}
