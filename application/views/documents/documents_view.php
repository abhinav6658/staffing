		...
		<div class="cols9">
			<div class="main-pagetable">
				...
				<div class="document-uploadBox">
					<a href="<?php echo base_url('/') ?>doc-upload-page/<?php echo $this->uri->segment(2) ?>/<?php 
							...
							if(!empty($this->uri->segment(3))) {
								...
								//echo $doc_name;
                                	...
                                	//echo $valid_from;
											...
											<td><?php if($filtered_data['valid_from']){ echo $valid_from; } ?></td>
											<td><?php if($filtered_data['valid_to']){ echo $valid_to; } ?></td>
											<td><?php 
											...
											<td width="5%">
												<ul class="table-actionBtn">
												<li>
													 <a style="color: blue;" href="<?php echo base_url('Documents/delete_document'); ?>/<?php echo $this->uri->segment(2) ?>?action=edit&id=<?php echo $filtered_data['doc_id']; ?>" onclick="return confirm('Are you sure?')"><img src="<?php echo base_url('assets/') ?>images/icon/delete.svg" alt="View"></a>
													 </li>
												<!--
                                	...
                                	//echo $valid_from;
										...
										<td>
											<ul class="table-actionBtn">
												...
												</a> / <a href="<?=base_url('assets/uploads/'.$doc_folder_name .'/' . $realdocfilename)?>" target="_blank">Download File
												</a>
												</li>
											</ul>
										</td>
