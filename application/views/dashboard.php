<div class="dashboard-countBox">
	<ul class="mainwork-items">
		...
		<li>
			<div class="dashb-Box">
				<a href="<?php echo base_url('pending-documents'); ?>"><h3><?php echo $consult_count; ?></h3></a>
				<a href="<?php echo base_url('pending-documents'); ?>"><p>Consultant Document Pending</p></a>
			</div>
			<!-- <a href="#" class="viewbtn">View</a> -->
		</li>
		<li>
			<div class="dashb-Box">
				<a href="<?php echo base_url('document-pending'); ?>"><h3><?php echo $vendor_count; ?></h3></a>
				<a href="<?php echo base_url('document-pending'); ?>"><p>Vendor Document Pending</p></a>
			</div>
			<!-- <a href="#" class="viewbtn">View</a> -->
		</li>
		<li>
			<div class="dashb-Box">
				<a href="<?php echo base_url('pending-timesheet'); ?>"><h3><?php echo $timesheet_count; ?></h3></a>
				<a href="<?php echo base_url('pending-timesheet'); ?>"><p>Timesheet Pending</p></a>
			</div>
			<!-- <a href="#" class="viewbtn">View</a> -->
		</li>
		<li>
			<div class="dashb-Box">
				<a href="<?php echo base_url('pending-bills'); ?>"><h3><?php echo $bills_count; ?></h3></a>
				<a href="<?php echo base_url('pending-bills'); ?>"><p>Billing Pending</p></a>
			</div>
			<!-- <a href="#" class="viewbtn">View</a> -->
		</li>
	</ul>
				...
				<tbody>
					...
					?>
								<tr>
									...
									<td width="10%"><a href="<?php echo base_url() ?>pending-timesheet/<?php echo $timesheet_val['consultant_id'] ?>/<?php echo $timesheet_val['date_from'] ?>"><img src="<?php echo base_url('/assets/images/icon'); ?>/action.svg" alt="Timesheet Upload"></a></td>
								</tr>
					<?php } } else {
