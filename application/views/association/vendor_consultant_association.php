...
<div class="dashboard-progressBox">
	<h3 class="black-headingCommon">Assign Consultant to Vendor</h3>
	...
	<?php echo form_open('Association/vendor_consultant_assoc', array('id'=>'msform')); ?>
		...
		<fieldset class="formSteps" id="form_fields">
			<h3 class="black-headingCommon">Assign Consultant</h3>
...
<script type="text/javascript">
	...
	jQuery(".submit").click(function(e) {
		...
		if(c_type != "" && consult != "" && vend != "" && pro_name != "" && con_frqc != "" && srt_date != "" && end_date != "" && emp_role != "" && pro_locn != "" && pro_city != "" && pro_stat != "" && rec_name != "" && man_name != "" && cost_prc != "" && sell_prc != "" && eff_date != "" && bill_eff != "") {
			...
			jQuery.ajax({
				...
				success: function(response) {
					// alert(response);
					if(response == 1) {
						window.location.href = "<?php echo base_url('Association/vendor_consultant_assoc'); ?>";
					}
				}
			});
		} else {
