								...
								<tr>
									...
									<td width="5%">
										<ul class="table-actionBtn">
											<li><a href="<?php echo base_url() ?>pending-c2c-bills/<?php echo $consult_data_value['consultant_id'] ?>"><img src="<?php echo base_url('assets/') ?>images/icon/view.svg" alt="Document"></a></li>
										</ul>
									</td>
								</tr>
					<?php
