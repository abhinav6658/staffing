...
<div class="dashboard-countBox">
	...
	<div class="formBox">
		<?php echo form_open_multipart('billssole/upload_bills', array('id' => 'bills_form')); ?>
		<div class="row">
	...
	<script type="text/javascript">
		...
		jQuery("#vendor_id").change(function() {
			// alert('clicked'); return false;
				...
				// 	window.location.href = "<?php echo base_url('billssole'); ?>?ven="+filter_sel+"&con="+consultant_id;
				// } else {
				// 	window.location.href = "<?php echo base_url('billssole'); ?>?ven="+filter_sel+"&con="+consultant_id;
				// }			
				jQuery.ajax({
					url: "<?php echo base_url('Billssole/getConsultants');?>",
					type: "GET",
					datatype: 'html',
					data: {
		...
		jQuery("#consultant_id").change(function() {
			...
			jQuery.ajax({
				url: "<?php echo base_url('Billssole/getTimesheetHrs');?>",
				type: "GET",
				//datatype: 'json',
				data: {
					vendor_id: filter_sel,
