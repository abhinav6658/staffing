								...
								<tr>
									...
									<td width="5%">
										<ul class="table-actionBtn">
											<li><a href="<?php echo base_url() ?>upload-pending-bills/<?php echo $consult[0]['consultant_id']; ?>/<?php echo $bills_value['id'] ?>"><img src="<?php echo base_url('assets/') ?>images/icon/action.svg" alt="Document"></a></li>
										</ul>
									</td>
								</tr>
					<?php
