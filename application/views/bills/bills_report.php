							...
							foreach($bills_data as $bills_data_value) {
							 ...
							 ?>
								...
								<td>
										<ul class="table-actionBtn">
											<li>
												 <a style="color: blue;" href="<?php echo base_url('Bills/delete_bills'); ?>?action=edit&id=<?php echo $bills_data_value['bill_id']; ?>" onclick="return confirm('Are you sure?')"><img src="<?php echo base_url('assets/') ?>images/icon/delete.svg" alt="View"></a>
												 </li>
											<!--
