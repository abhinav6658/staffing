...
<div class="dashboard-countBox">
	...
	<div class="formBox">
		<?php echo form_open_multipart('timesheet/timesheet_upload', array('id'=>'ts_form')); ?>
...
<script type="text/javascript">
 ...
 //  	});
	...
	// 	jQuery("#row_id_"+row_num+"").hide();
	// 	//var arr_val = jQuery("#remove_ids").val();
	// 	// if(arr_val != "") {
	// 	// 	for (var i = arr_val.length - 1; i >= 0; i--) {
	// 	// 		arr_val[i];
	// 	// 	}
	// 	// }
	// 	// jQuery("#remove_ids").val();
	// 	// var remove_ids_arr[] = row_num;
	// 	// alert(remove_ids_arr);
	// 	// jQuery("#remove_ids").val(remove_ids_arr);
