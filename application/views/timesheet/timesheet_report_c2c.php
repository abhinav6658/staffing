					...
					?>
								<tr>
									...
									<td width="5%">
										<ul class="table-actionBtn">
											<li>
												 <a style="color: blue;" href="<?php echo base_url('Timesheetc2c/delete_timesheet'); ?>?action=edit&id=<?php echo $con_value['id']; ?>" onclick="return confirm('Are you sure?')"><img src="<?php echo base_url('assets/') ?>images/icon/delete.svg" alt="View"></a>
												 </li>
											<!--
