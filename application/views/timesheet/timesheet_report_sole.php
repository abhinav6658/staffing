					...
					?>
								<tr>
									...
									<ul class="table-actionBtn">
										...
										<li><a href="<?=base_url('assets/uploads/'.$file_folder_name .'/' . $TempfileName .'.'. $fileExt)?>" target="_blank" data-toggle="modal" data-target="#TimeSheetModel_<?php echo $modal_id; ?>"><img src="<?php echo base_url('assets/') ?>images/icon/view.svg" alt="View"></a> / <a href="<?=base_url('assets/uploads/'.$file_folder_name .'/' . $TempfileName .'.'. $fileExt)?>" target="_blank">Download File</a>
										</li>
									...
									<td width="5%">
										<ul class="table-actionBtn">
											<li>
												 <a style="color: blue;" href="<?php echo base_url('Timesheetsole/delete_timesheet'); ?>?action=edit&id=<?php echo $con_value['id']; ?>" onclick="return confirm('Are you sure?')"><img src="<?php echo base_url('assets/') ?>images/icon/delete.svg" alt="View"></a>
												 </li>
											<!--
